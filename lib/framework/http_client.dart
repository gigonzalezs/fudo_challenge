...
class HttpClient {
  ...
  late final http.Client Function() _clientProvider;

  HttpClient({http.Client Function()? clientProvider}) {
    _clientProvider = clientProvider ?? () => http.Client();
  }
  ...
  Future<T> _withClient<T>(Future<T> Function(http.Client) fn) async {
    var client = _clientProvider.call();
    try {
